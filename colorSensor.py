...
'''
Пример работы с датчиком цвета
...
class TCS34725(object):
    ...
    def __init__(self, integration_time=TCS34725_INTEGRATIONTIME_2_4MS,
        ...
        #print(i2c.scan(), i2c.is_ready(i2c.scan()[0]))
    ...
    def _readU8(self, reg):
        ...
        return self._device.mem_read(1, ADDRESSI2C,TCS34725_COMMAND_BIT | reg)

    def _readU16LE(self, reg):
        """Read a 16-bit little endian register."""
        return self._device.mem_read(2, ADDRESSI2C,TCS34725_COMMAND_BIT | reg)

    def _write8(self, reg, value):
        """Write a 8-bit value to a register."""
        self._device.mem_write(value, ADDRESSI2C ,TCS34725_COMMAND_BIT | reg)
    ...
    def clear_interrupt(self):
        """Clear interrupt."""
        self._device.mem_write(0x66 & 0xff)

    def set_interrupt_limits(self, low, high):
        """Set the interrupt limits to provied unsigned 16-bit threshold values.
        """
        self._device.mem_write(low & 0xFF, ADDRESSI2C, 0x04)
        self._device.mem_write(low >> 8, ADDRESSI2C, 0x05)
        self._device.mem_write(high & 0xFF, ADDRESSI2C, 0x06)
        self._device.mem_write(high >> 8, ADDRESSI2C, 0x07)
